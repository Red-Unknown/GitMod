              ...
              Expanded(
                child: SafeArea(
                  child: ListView(
                    ...
                    children: [
                      Text('组件预览', style: Theme.of(context).textTheme.headlineSmall),
                      const SizedBox(height: AppSpace.xs),
                      Text('深色桌面工作台基础组件', style: Theme.of(context).textTheme.bodySmall),
                    ...
                    child: const Wrap(
                      ...
                      children: [
                        AppStatusBadge(label: '连接正常', tone: AppStatusTone.normal),
                        AppStatusBadge(label: '同步完成', tone: AppStatusTone.success),
                        AppStatusBadge(label: '发现更新', tone: AppStatusTone.warning),
                        AppStatusBadge(label: '无法连接仓库', tone: AppStatusTone.error),
                      ],
                    ),
                  ),
                      _Section(
                    ...
                    child: Wrap(
                      ...
                      children: [
                        AppActionButton(label: '同步更新', icon: Icons.sync, onPressed: () {}),
                        AppActionButton(label: '正在同步', isLoading: true, onPressed: () {}),
                        const AppActionButton(label: '暂不可用', icon: Icons.lock_outline),
                        AppActionButton(
                          label: '打开 Mod 目录',
                    ...
                    child: AppInfoPanel(
                      title: '仓库信息',
                      trailing: const AppStatusBadge(label: '已连接', tone: AppStatusTone.success),
                      child: Column(
                        children: const [
                          AppFieldRow(
                            label: '仓库地址',
                          ...
                          AppFieldRow(
                            label: 'Mod 目录',
                            helper: '请选择独立的 Mod 根目录。',
                            child: TextField(
                              controller: null,
                              decoration: InputDecoration(hintText: 'D:\\Games\\Example\\Mods'),
                            ),
                          ),
                        ],
                      ),
